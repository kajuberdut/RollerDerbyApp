...
def get_bout_by_address_date_time_team_opposing_team(db: Session, bout: Bout): 
...
def get_mixer_by_address_date_time_theme(db: Session, mixer: Mixer): 
    print("**** mixer ******:", mixer)
...
# def create_user(derby_name: str, email: str, password: str, db: Session, user: UserCreate):
...
def update_user(db: Session, user: UserUpdate, user_id): 
...
def delete_user(db: Session, user: UserDelete, user_id): 
...
def create_bout(db: Session, bout: Bout):
...
def create_mixer(db: Session, mixer: Mixer):
...
def update_bout(db: Session, bout: BoutUpdate, event_id): 
...
def update_mixer(db: Session, mixer: MixerUpdate, event_id): 
...
def delete_bout(db: Session, bout: EventDelete, event_id): 
    # print("user in delete user crud.py", user)
    # print("you are hitting delete_user in crud.py")
...
def delete_mixer(db: Session, mixer: EventDelete, event_id): 
...
def get_address(db: Session, address: Address):
...
# def get_ruleset(db: Session, ruleset: Ruleset):
...
# def create_ruleset(db: Session, ruleset: Ruleset):
...
def get_position(db: Session, position: Position):
...
def get_insurance(db: Session, insurance: Insurance):
...
def create_insurance(db: Session, insurance: Insurance):
...
def get_location(db: Session, location: Location):
...
def add_user_to_group(db: Session, user_group: UserGroup):
